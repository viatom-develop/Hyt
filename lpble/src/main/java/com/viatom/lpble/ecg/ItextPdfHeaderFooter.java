...
public class ItextPdfHeaderFooter extends PdfPageEventHelper {
    ...
    public ItextPdfHeaderFooter(BaseFont font, byte[] toByteArray) {
        this.bf = font;
        this.headImageArray = toByteArray;
    }
    ...
    public void onOpenDocument(PdfWriter writer, Document document) {
        ...
        try {
            Image image = Image.getInstance(headImageArray);
    ...
    public void onCloseDocument(PdfWriter writer, Document document) {
        ...
        String foot2 = " " + (writer.getPageNumber() - 1) + " 页"; //自动newPage()会导致总页数比实际页数大1
